...
class ComposerAutoloaderInit59dd31c3fb52e7d3c9ff2caecc0ff26e
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit59dd31c3fb52e7d3c9ff2caecc0ff26e::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire59dd31c3fb52e7d3c9ff2caecc0ff26e($fileIdentifier, $file);
        }
...
function composerRequire59dd31c3fb52e7d3c9ff2caecc0ff26e($fileIdentifier, $file)
{
